...
// let randomEmployee = employee.firstName, employee.lastName[index];
// console.log("Congratulations to "+employee.firstName+" "+employeeLastName+", our random drawing winner!");
};
